...
gnome-terminal -- bash -c 'afl-fuzz -t 5000 -m 500 -i ./test/fuzzing/input/ -o ./test/fuzzing/output/sync_dir/ -M fuzzer1  ./_build/default/test/fuzzing/afl_fuzzing.exe @@; exec bash'
